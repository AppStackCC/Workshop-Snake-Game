...
void GameUpdate()
{
  ...
  switch (bModeState)
  {
    case 0 :
      ...
      if (GameInput::getKeyDown(iInput1Pin, LOW, bInput1BuffRead))
      {
        bModeState = 1;
        bBtnState = 0;
        bInput2BuffRead = HIGH;
      }
    ...
    case 1 :
      ...
      //
      if (GameInput::getKeyDown(iInput2Pin, LOW, bInput2BuffRead))
      {
        if (bBtnState == 0) {
          bBtnState = 1;
        } else if (bBtnState == 1) {
    ...
    case 2 :
      ...
      //
      if (GameInput::getKeyUp(iInput2Pin, LOW, bInput2BuffRead))
      {
        if (bBtnState == 0) {
          bBtnState = 1;
        } else if (bBtnState == 1) {
